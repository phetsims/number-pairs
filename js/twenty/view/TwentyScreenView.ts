...
type TwentyScreenViewOptions = SelfOptions & ScreenViewOptions;

export default class TwentyScreenView extends ScreenView {

  public constructor( model: TwentyModel, providedOptions: TwentyScreenViewOptions ) {

    const options = optionize<TwentyScreenViewOptions, SelfOptions, ScreenViewOptions>()( {
