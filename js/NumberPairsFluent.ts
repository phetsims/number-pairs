  ...
  a11y: {
    ...
    controls: {
      ...
      numberModel: {
        ...
        numberBondStateAccessibleParagraph: new FluentPattern<{ left: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | TReadOnlyProperty<number | 'other' | 'sumScreen'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_numberBondStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.numberBondStateAccessibleParagraphStringProperty' ), [{"name":"left"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen"]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
        barModelStateAccessibleParagraph: new FluentPattern<{ left: FluentVariable, proportions: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | TReadOnlyProperty<number | 'other' | 'sumScreen'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_barModelStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.barModelStateAccessibleParagraphStringProperty' ), [{"name":"left"},{"name":"proportions"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen"]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
