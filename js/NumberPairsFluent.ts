...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    gameScreen: {
      ...
      responses: {
        answerSelected: new FluentPattern<{ challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, color: FluentVariable, representationType: 'kittens' | 'numberLine' | TReadOnlyProperty<'kittens' | 'numberLine'>, value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_responses_answerSelected', _.get( NumberPairsStrings, 'a11y.gameScreen.responses.answerSelectedStringProperty' ), [{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"color"},{"name":"representationType","variants":["kittens","numberLine"]},{"name":"value"}] ),
