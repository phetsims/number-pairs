...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    gameScreen: {
      ...
      challengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, color: FluentVariable, decompositionOrSum: 'decomposition' | 'sum' | TReadOnlyProperty<'decomposition' | 'sum'>, leftAddend: FluentVariable, levelType: 'kittens' | 'numberLine' | TReadOnlyProperty<'kittens' | 'numberLine'>, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_challengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.challengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"color"},{"name":"decompositionOrSum","variants":["decomposition","sum"]},{"name":"leftAddend"},{"name":"levelType","variants":["kittens","numberLine"]},{"name":"rightAddend"},{"name":"total"}] ),
