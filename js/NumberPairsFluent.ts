...
addToMapIfDefined( 'a11y_controls_numberModel_currentNumberBondOrBarStateAccessibleParagraph', 'a11y.controls.numberModel.currentNumberBondOrBarStateAccessibleParagraphStringProperty' );
  ...
  a11y: {
    ...
    controls: {
      ...
      numberModel: {
        ...
        currentNumberBondOrBarStateAccessibleParagraph: new FluentPattern<{ barOrBondOrEquation: 'numberBond' | 'barModel' | 'sumEquation' | 'decompositionEquation' | TReadOnlyProperty<'numberBond' | 'barModel' | 'sumEquation' | 'decompositionEquation'>, left: FluentVariable, proportions: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | number | 'other' | TReadOnlyProperty<number | 'other' | 'sumScreen' | number | 'other'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_currentNumberBondOrBarStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.currentNumberBondOrBarStateAccessibleParagraphStringProperty' ), [{"name":"barOrBondOrEquation","variants":["numberBond","barModel","sumEquation","decompositionEquation"]},{"name":"left"},{"name":"proportions"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen",{"type":"number","value":"other"}]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
    ...
    gameScreen: {
      ...
      countingArea: {
        ...
        numberLineTickMarks: new FluentPattern<{ leftAddend: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_countingArea_numberLineTickMarks', _.get( NumberPairsStrings, 'a11y.gameScreen.countingArea.numberLineTickMarksStringProperty' ), [{"name":"leftAddend"}] ),
        accessibleParagraph: new FluentPattern<{ guess: FluentVariable, leftAddend: FluentVariable, rightAddend: FluentVariable, type: 'kittens' | 'numberLine' | TReadOnlyProperty<'kittens' | 'numberLine'>, visible: 'none' | 'addends' | 'tickMarks' | 'both' | TReadOnlyProperty<'none' | 'addends' | 'tickMarks' | 'both'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen_countingArea_accessibleParagraph', _.get( NumberPairsStrings, 'a11y.gameScreen.countingArea.accessibleParagraphStringProperty' ), [{"name":"guess"},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"type","variants":["kittens","numberLine"]},{"name":"visible","variants":["none","addends","tickMarks","both"]}] )
      },
