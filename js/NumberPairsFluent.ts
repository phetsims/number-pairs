...
addToMapIfDefined( 'a11y_gameScreen__addendOrSum', 'a11y.gameScreen._addendOrSumStringProperty' );
...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    gameScreen: {
      ...
      _addendOrSum: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen__addendOrSum', _.get( NumberPairsStrings, 'a11y.gameScreen._addendOrSumStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]}] ),
      ...
      responses: {
        _comment_0: new FluentComment( {"comment":"TODO: use select syntax","associatedKey":"answerSelected"} ),
