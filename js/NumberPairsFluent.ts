...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    sumScreen: {
      screenSummary: {
        playArea: new FluentPattern<{ numberBarOrBarModel: FluentVariable, representationType: 'numberLine' | number | 'other' | TReadOnlyProperty<'numberLine' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_sumScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.sumScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberBarOrBarModel"},{"name":"representationType","variants":["numberLine",{"type":"number","value":"other"}]}] ),
