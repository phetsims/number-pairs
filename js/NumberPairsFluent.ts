...
addToMapIfDefined( 'a11y_gameScreen__accessibleChallengePromptFinalSentence', 'a11y.gameScreen._accessibleChallengePromptFinalSentenceStringProperty' );
...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    introScreen: {
      screenSummary: {
        playArea: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_introScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.introScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
    ...
    tenOrTwentyScreen: {
      screenSummary: {
        playAreaEndSentence: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_tenOrTwentyScreen_screenSummary_playAreaEndSentence', _.get( NumberPairsStrings, 'a11y.tenOrTwentyScreen.screenSummary.playAreaEndSentenceStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
        playArea: new FluentPattern<{ numberBondOrBarModel: FluentVariable, representationType: 'numberLine' | 'beads' | 'kittens' | 'location' | TReadOnlyProperty<'numberLine' | 'beads' | 'kittens' | 'location'> }>( fluentSupport.bundleProperty, 'a11y_tenOrTwentyScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.tenOrTwentyScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberBondOrBarModel"},{"name":"representationType","variants":["numberLine","beads","kittens","location"]}] ),
    ...
    sumScreen: {
      screenSummary: {
        playArea: new FluentPattern<{ numberBondOrBarModel: FluentVariable, representation: FluentVariable, representationType: 'numberLine' | number | 'other' | TReadOnlyProperty<'numberLine' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_sumScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.sumScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberBondOrBarModel"},{"name":"representation"},{"name":"representationType","variants":["numberLine",{"type":"number","value":"other"}]}] ),
    ...
    controls: {
      ...
      numberModel: {
        ...
        accessibleHelpText: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_accessibleHelpText', _.get( NumberPairsStrings, 'a11y.controls.numberModel.accessibleHelpTextStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
        numberBondAccessibleParagraph: new FluentPattern<{ screenType: 'sumScreen' | number | 'other' | TReadOnlyProperty<'sumScreen' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_numberBondAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.numberBondAccessibleParagraphStringProperty' ), [{"name":"screenType","variants":["sumScreen",{"type":"number","value":"other"}]}] ),
        currentNumberBondStateAccessibleParagraph: new FluentPattern<{ left: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | TReadOnlyProperty<number | 'other' | 'sumScreen'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_currentNumberBondStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.currentNumberBondStateAccessibleParagraphStringProperty' ), [{"name":"left"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen"]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
        barModelAccessibleParagraph: new FluentPattern<{ screenType: number | 'other' | 'sumScreen' | TReadOnlyProperty<number | 'other' | 'sumScreen'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_barModelAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.barModelAccessibleParagraphStringProperty' ), [{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen"]}] ),
        currentBarModelStateAccessibleParagraph: new FluentPattern<{ left: FluentVariable, proportions: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | TReadOnlyProperty<number | 'other' | 'sumScreen'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_currentBarModelStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.currentBarModelStateAccessibleParagraphStringProperty' ), [{"name":"left"},{"name":"proportions"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen"]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
      ...
      bothAddendsVisibleButton: {
        ...
        accessibleHelpTextPattern: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_controls_bothAddendsVisibleButton_accessibleHelpTextPattern', _.get( NumberPairsStrings, 'a11y.controls.bothAddendsVisibleButton.accessibleHelpTextPatternStringProperty' ), [{"name":"numberBondOrBarModel"}] )
      },
      addendVisibleButton: {
        ...
        accessibleHelpTextPattern: new FluentPattern<{ addend: FluentVariable, numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_controls_addendVisibleButton_accessibleHelpTextPattern', _.get( NumberPairsStrings, 'a11y.controls.addendVisibleButton.accessibleHelpTextPatternStringProperty' ), [{"name":"addend"},{"name":"numberBondOrBarModel"}] ),
    ...
    gameScreen: {
      ...
      decompositionChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_decompositionChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.decompositionChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] ),
      challengeSumPrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_challengeSumPrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.challengeSumPromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] ),
      _accessibleChallengePromptFinalSentence: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen__accessibleChallengePromptFinalSentence', _.get( NumberPairsStrings, 'a11y.gameScreen._accessibleChallengePromptFinalSentenceStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]}] ),
      ...
      level1: {
        accessibleHelpText: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level1_accessibleHelpText', _.get( NumberPairsStrings, 'a11y.gameScreen.level1.accessibleHelpTextStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level1_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level1.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level2: {
        accessibleHelpText: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level2_accessibleHelpText', _.get( NumberPairsStrings, 'a11y.gameScreen.level2.accessibleHelpTextStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level2_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level2.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level3: {
        ...
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level3_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level3.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level4: {
        ...
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level4_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level4.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level5: {
        accessibleHelpText: new FluentPattern<{ numberBondOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level5_accessibleHelpText', _.get( NumberPairsStrings, 'a11y.gameScreen.level5.accessibleHelpTextStringProperty' ), [{"name":"numberBondOrBarModel"}] ),
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level5_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level5.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level6: {
        ...
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level6_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level6.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level7: {
        ...
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level7_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level7.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      level8: {
        ...
        accessibleChallengePrompt: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, leftAddend: FluentVariable, rightAddend: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_level8_accessibleChallengePrompt', _.get( NumberPairsStrings, 'a11y.gameScreen.level8.accessibleChallengePromptStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"leftAddend"},{"name":"rightAddend"},{"name":"total"}] )
      },
      answerButton: {
      ...
      responses: {
        answerSelected: new FluentPattern<{ challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'>, representationType: 'kittens' | 'numberLine' | TReadOnlyProperty<'kittens' | 'numberLine'>, value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_responses_answerSelected', _.get( NumberPairsStrings, 'a11y.gameScreen.responses.answerSelectedStringProperty' ), [{"name":"challengeType","variants":["leftAddend","rightAddend","total"]},{"name":"representationType","variants":["kittens","numberLine"]},{"name":"value"}] ),
