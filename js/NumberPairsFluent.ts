...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    grabOrReleaseInteraction: {
      releasedHelpText: new FluentPattern<{ representation: FluentVariable, representationType: 'beads' | number | 'other' | TReadOnlyProperty<'beads' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_grabOrReleaseInteraction_releasedHelpText', _.get( NumberPairsStrings, 'a11y.grabOrReleaseInteraction.releasedHelpTextStringProperty' ), [{"name":"representation"},{"name":"representationType","variants":["beads",{"type":"number","value":"other"}]}] ),
