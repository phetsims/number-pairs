...
addToMapIfDefined( 'a11y_gameScreen_addendOrSum', 'a11y.gameScreen.addendOrSumStringProperty' );
...
addToMapIfDefined( 'a11y_gameScreen_responses_correctAnswerScore', 'a11y.gameScreen.responses.correctAnswerScoreStringProperty' );
...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    gameScreen: {
      ...
      addendOrSum: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen_addendOrSum', _.get( NumberPairsStrings, 'a11y.gameScreen.addendOrSumStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]}] ),
      accessibleChallengePromptFinalSentence: new FluentPattern<{ addendOrSum: 'addend' | 'sum' | TReadOnlyProperty<'addend' | 'sum'>, challengeType: 'leftAddend' | 'rightAddend' | 'total' | TReadOnlyProperty<'leftAddend' | 'rightAddend' | 'total'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen_accessibleChallengePromptFinalSentence', _.get( NumberPairsStrings, 'a11y.gameScreen.accessibleChallengePromptFinalSentenceStringProperty' ), [{"name":"addendOrSum","variants":["addend","sum"]},{"name":"challengeType","variants":["leftAddend","rightAddend","total"]}] ),
      ...
      responses: {
        ...
        correctAnswerScore: new FluentPattern<{ score: 1 | number | 'other' | TReadOnlyProperty<1 | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen_responses_correctAnswerScore', _.get( NumberPairsStrings, 'a11y.gameScreen.responses.correctAnswerScoreStringProperty' ), [{"name":"score","variants":[1,{"type":"number","value":"other"}]}] )
      },
