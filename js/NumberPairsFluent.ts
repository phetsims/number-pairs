...
addToMapIfDefined( 'a11y_sumScreen_screenSummary_playAreaEndSentence', 'a11y.sumScreen.screenSummary.playAreaEndSentenceStringProperty' );
...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    introScreen: {
      screenSummary: {
        playArea: new FluentPattern<{ numberModelType: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'> }>( fluentSupport.bundleProperty, 'a11y_introScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.introScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberModelType","variants":["numberBond","barModel"]}] ),
    ...
    tenOrTwentyScreen: {
      screenSummary: {
        playAreaEndSentence: new FluentPattern<{ numberModelType: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'> }>( fluentSupport.bundleProperty, 'a11y_tenOrTwentyScreen_screenSummary_playAreaEndSentence', _.get( NumberPairsStrings, 'a11y.tenOrTwentyScreen.screenSummary.playAreaEndSentenceStringProperty' ), [{"name":"numberModelType","variants":["numberBond","barModel"]}] ),
        playArea: new FluentPattern<{ numberModelType: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'>, representationType: 'numberLine' | 'beads' | 'kittens' | 'location' | TReadOnlyProperty<'numberLine' | 'beads' | 'kittens' | 'location'> }>( fluentSupport.bundleProperty, 'a11y_tenOrTwentyScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.tenOrTwentyScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberModelType","variants":["numberBond","barModel"]},{"name":"representationType","variants":["numberLine","beads","kittens","location"]}] ),
        ...
        currentDetails: new FluentPattern<{ itemType: FluentVariable, representationType: 'numberLine' | 'beads' | 'kittens' | 'location' | 'apples' | TReadOnlyProperty<'numberLine' | 'beads' | 'kittens' | 'location' | 'apples'>, shownSides: 'none' | 'right' | 'left' | 'both' | TReadOnlyProperty<'none' | 'right' | 'left' | 'both'>, total: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_tenOrTwentyScreen_screenSummary_currentDetails', _.get( NumberPairsStrings, 'a11y.tenOrTwentyScreen.screenSummary.currentDetailsStringProperty' ), [{"name":"itemType"},{"name":"representationType","variants":["numberLine","beads","kittens","location","apples"]},{"name":"shownSides","variants":["none","right","left","both"]},{"name":"total","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
    ...
    sumScreen: {
      screenSummary: {
        playArea: new FluentPattern<{ numberModelType: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'>, representation: FluentVariable, representationType: 'numberLine' | number | 'other' | TReadOnlyProperty<'numberLine' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_sumScreen_screenSummary_playArea', _.get( NumberPairsStrings, 'a11y.sumScreen.screenSummary.playAreaStringProperty' ), [{"name":"numberModelType","variants":["numberBond","barModel"]},{"name":"representation"},{"name":"representationType","variants":["numberLine",{"type":"number","value":"other"}]}] ),
        playAreaEndSentence: new FluentPattern<{ numberModelType: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'> }>( fluentSupport.bundleProperty, 'a11y_sumScreen_screenSummary_playAreaEndSentence', _.get( NumberPairsStrings, 'a11y.sumScreen.screenSummary.playAreaEndSentenceStringProperty' ), [{"name":"numberModelType","variants":["numberBond","barModel"]}] ),
    ...
    gameScreen: {
      ...
      responses: {
        ...
        _correctAnswerScore: new FluentPattern<{ score: 1 | number | 'other' | TReadOnlyProperty<1 | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_gameScreen_responses__correctAnswerScore', _.get( NumberPairsStrings, 'a11y.gameScreen.responses._correctAnswerScoreStringProperty' ), [{"name":"score","variants":[1,{"type":"number","value":"other"}]}] )
      },
