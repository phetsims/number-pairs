...
addToMapIfDefined( 'a11y_tenScreen_screenSummary_playArea_description', 'a11y.tenScreen.screenSummary.playArea.descriptionStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_playArea_numberLine', 'a11y.tenScreen.screenSummary.playArea.numberLineStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_playArea_other', 'a11y.tenScreen.screenSummary.playArea.otherStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_controlArea', 'a11y.tenScreen.screenSummary.controlAreaStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_currentDetails_countingAreaShown', 'a11y.tenScreen.screenSummary.currentDetails.countingAreaShownStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_currentDetails_countingAreaShownWithNumberLine', 'a11y.tenScreen.screenSummary.currentDetails.countingAreaShownWithNumberLineStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_currentDetails_countingAreaHidden', 'a11y.tenScreen.screenSummary.currentDetails.countingAreaHiddenStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_interactionHint_beads', 'a11y.tenScreen.screenSummary.interactionHint.beadsStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_interactionHint_kittens', 'a11y.tenScreen.screenSummary.interactionHint.kittensStringProperty' );
addToMapIfDefined( 'a11y_tenScreen_screenSummary_interactionHint_numberLine', 'a11y.tenScreen.screenSummary.interactionHint.numberLineStringProperty' );
...
const NumberPairsFluent = {
  ...
  a11y: {
    ...
    tenScreen: {
      screenSummary: {
        playArea: {
          description: new FluentPattern<{ firstSentence: FluentVariable, numberBarOrBarModel: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_tenScreen_screenSummary_playArea_description', _.get( NumberPairsStrings, 'a11y.tenScreen.screenSummary.playArea.descriptionStringProperty' ), [{"name":"firstSentence"},{"name":"numberBarOrBarModel"}] ),
          _comment_0: new FluentComment( {"comment":"Number line","associatedKey":"numberLine"} ),
          numberLineStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_tenScreen_screenSummary_playArea_numberLine', _.get( NumberPairsStrings, 'a11y.tenScreen.screenSummary.playArea.numberLineStringProperty' ) ),
          otherStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_tenScreen_screenSummary_playArea_other', _.get( NumberPairsStrings, 'a11y.tenScreen.screenSummary.playArea.otherStringProperty' ) )
        },
        ...
        interactionHint: {
          ...
          kittensStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_tenScreen_screenSummary_interactionHint_kittens', _.get( NumberPairsStrings, 'a11y.tenScreen.screenSummary.interactionHint.kittensStringProperty' ) ),
          _comment_0: new FluentComment( {"comment":"Number line","associatedKey":"numberLine"} ),
          numberLineStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_tenScreen_screenSummary_interactionHint_numberLine', _.get( NumberPairsStrings, 'a11y.tenScreen.screenSummary.interactionHint.numberLineStringProperty' ) )
        }
      }
    },
    ...
    countingArea: {
      ...
      _comment_0: new FluentComment( {"comment":"TODO: https://github.com/phetsims/number-pairs/issues/200 What does the NUMBER syntax do here, and what would go wrong without it?","associatedKey":"leadingParagraph"} ),
    ...
    controls: {
      ...
      numberModel: {
        ...
        _comment_1: new FluentComment( {"comment":"TODO https://github.com/phetsims/number-pairs/issues/200 should proportion be changed to proportions?","associatedKey":"currentBarModelStateAccessibleParagraph"} ),
        currentBarModelStateAccessibleParagraph: new FluentPattern<{ left: FluentVariable, proportion: FluentVariable, right: FluentVariable, total: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_currentBarModelStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.currentBarModelStateAccessibleParagraphStringProperty' ), [{"name":"left"},{"name":"proportion"},{"name":"right"},{"name":"total"}] ),
