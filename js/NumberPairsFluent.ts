  ...
  a11y: {
    ...
    controls: {
      ...
      numberModel: {
        ...
        currentNumberBondOrBarStateAccessibleParagraph: new FluentPattern<{ barOrBond: 'numberBond' | 'barModel' | TReadOnlyProperty<'numberBond' | 'barModel'>, left: FluentVariable, proportions: FluentVariable, right: FluentVariable, screenType: number | 'other' | 'sumScreen' | number | 'other' | TReadOnlyProperty<number | 'other' | 'sumScreen' | number | 'other'>, total: FluentVariable, totalView: 'shown' | 'hidden' | TReadOnlyProperty<'shown' | 'hidden'> }>( fluentSupport.bundleProperty, 'a11y_controls_numberModel_currentNumberBondOrBarStateAccessibleParagraph', _.get( NumberPairsStrings, 'a11y.controls.numberModel.currentNumberBondOrBarStateAccessibleParagraphStringProperty' ), [{"name":"barOrBond","variants":["numberBond","barModel"]},{"name":"left"},{"name":"proportions"},{"name":"right"},{"name":"screenType","variants":[{"type":"number","value":"other"},"sumScreen",{"type":"number","value":"other"}]},{"name":"total"},{"name":"totalView","variants":["shown","hidden"]}] ),
